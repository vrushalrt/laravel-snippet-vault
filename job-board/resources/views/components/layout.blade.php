...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="mx-auto mt-10 max-w-2xl bg-gradient-to-r from-indigo-200 from-10% via-sky-200 via-30% to-emerald-300 to-90% text-slate-700">
        <nav class="mb-8 flex justify-between text-lg font-medium">
            ...
            <ul class="flex-x-2">
                @auth
                <li>
                    <a href="{{route('my-jobs-applications.index')}}">
                        {{ auth()->user()->name ?? 'Annonymous' }} : Applications
                    </a>
                </li>
                <li>
